  ...
  return (
    <View style={styleSheet.MainContainer}>
      ...
      <View style={styleSheet.Container}>
        ...
        <Text style={Theme.titleRegister}>Les séries que j'aime <Text style={{color:'#FF5D5D'}}>*</Text></Text>
        <TextInput
          style={Theme.input}
          ...
          placeholder=""
        />
        <Pressable  style={Theme.buttonRegister} onPress={() => navigation.navigate('Login')}>
